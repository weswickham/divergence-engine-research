...
I independently flagged the disruptors parameter as ineffective in both sessions. The disruptor concept was established in early DE versions as a mechanism to inject unexpected semantic material — to jar the model sideways from the anchor domains. In practice, the disruptor column functions as little more than an additional anchor column with a different subject. It is not doing what it was designed to do.
